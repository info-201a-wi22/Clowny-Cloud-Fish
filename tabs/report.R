...
report_tab <- tabPanel(
  ...
  mainPanel(
    width = 7,
    tags$span("Project Title: Broadband Effect on Education"),
    tags$br(),
    tags$br(),
    tags$span("Authors: Hanna Lee, Daniel Lee, Nick Vaughn, John Nguyen"),
    tags$br(),
    tags$br(),
    tags$span("Affiliation: University of Washington"),
    tags$br(),
    tags$br(),
    tags$span("Date: 03 / 04 / 2022"),
    tags$br(),
    tags$br(),
    tags$div(tags$h3("Key Words"),
             tags$br(),
             "1) Broadband",
             tags$br(),
    ...
    tags$br(),
    tags$div(tags$h3("Project Framing"),
             tags$br(),
    ...
    tags$br(),
    tags$br(),
    tags$div(tags$h4("Direct Stakeholders"),
             tags$br(),
             tags$b("Educational Institutions"),
    ...
    tags$br(),
    tags$br(),
    tags$div(tags$h4("Indirect Stakeholders"),
             tags$br(),
    ...
    tags$br(),
    tags$div(tags$h3("Research Questions"),
             tags$br(),
             tags$span(class = "research_question", "1) Does limited broadband access impact on test satisfactory levels?"),
             tags$br(),
             tags$br(),
             tags$span(class = "research_question", "2) Is broadband access a factor in the different test subject performance?"),
             tags$br(),
             tags$br(),
             tags$span(class = "research_question", "3) Does English as a second language students performance differ based on broadband speeds?")
    ),
    tags$br(),
    tags$div(tags$h3("The Dataset"),
             tags$br(),
