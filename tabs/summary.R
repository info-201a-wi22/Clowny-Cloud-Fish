...
summary_tab <- tabPanel(
  ...
  mainPanel(tags$div(class = "text",
    ...
    tags$br(),
    tags$br(),
    tags$p(class = "takeaway", "2) All school subjects seem to be similarly unaffected by broadband quality. There was not a single subject in our analysis that heavily deviated from other subjects in terms of correlation with broadband quality. Better broadband quality does not seem to heavily facilitate or hinder performance in any particular subject. It would be interesting to test a subject such as computer science."),
    tags$br(),
    tags$br(),
    tags$p(class = "takeaway", "3) All grade levels seem to be similary unaffected by broadband quality. We initially thought broadband would be better utilized by more mature and sophisticated high school students. However, our analysis shows that the effect of broadband is similar for both middle schoolers and high schoolers.")
  ))
)
