...
vdata_2 <- student_broadband_combine(data_1)
...
```
#### Purpose
Due to language barrier, we wanted to observe how those students' academics were impacted by broadband access. In these charts
#### Observations and Insights