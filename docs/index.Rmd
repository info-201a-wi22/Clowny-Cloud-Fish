...
Medium Internet speed is considered to be at least 100 Mbps.
<br><br>
...
```{r, ms_broadband, echo = FALSE, fig.show="hold", out.width="70%"}
...
```{r, hs_broadband, echo = FALSE, fig.show="hold", out.width="70%"}
...
#### Observations and Insights
For easier analysis, I broken down the data between middle and high school students. From there, we see satisfactory percentage in each county based on having a broadband provider. With middle school students, the correlation between broadband access and having a satisfactory grade on the state test is good. We do have outlier in some counties, and if we discount those, we do see the upticks in counties that broadband access vs. those who do not have access. In particular,  The peaks happen in larger counties therefore, we have made assumptions
